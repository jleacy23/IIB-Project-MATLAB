function build_eq_clk_combined_cd_fd_godard_adaptive_fxp_mex(P, cfg)
%BUILD_EQ_CLK_COMBINED_CD_FD_GODARD_ADAPTIVE_FXP_MEX
%   Compile eq_clk.combined_cd_fd_godard_adaptive_fxp to MEX.
%
...
%     P.AEQ_Mode, P.AEQ_BlockLen, P.AEQ_SubframeBlocks
    ...
    mexFile = fullfile(srcDir, '+eq_clk', ...
        'combined_cd_fd_godard_adaptive_fxp_mex.mexw64');
    if isfile(mexFile)
        delete(mexFile);
    ...
    codegen('-config', cfg, ...
            ...
            '-o', fullfile(srcDir, '+eq_clk', ...
                'combined_cd_fd_godard_adaptive_fxp_mex'));
    fprintf('  eq_clk.combined_cd_fd_godard_adaptive_fxp_mex  OK\n');
end
