function w = genVVFilter(Linewidth, Rs, SNR, SymbolEnergy, NPol, NTaps)
%GENVVFILTER  Generate Wiener-optimised Viterbi-Viterbi filter.
%
%   w = carrier_recovery.genVVFilter(Linewidth, Rs, SNR, SymbolEnergy, NPol, NTaps)
%
%   Inputs
