function T = clk_recovery_fxp_types(dt) %#codegen
%CLK_RECOVERY_FXP_TYPES  Data-type table for clk_recovery_fxp.
%
%   T = clk_recovery_fxp_types(dt)
%
%   Returns a struct of fi prototype objects that define every fixed-point
%   type used inside clk_recovery_fxp.
%
...
%     T.coeff - interpolator polynomial coefficients (1/6, 1/2, 1/3, …)
    ...
    switch dt
        ...
        otherwise
            error('clk_recovery_fxp_types:BadType', ...
