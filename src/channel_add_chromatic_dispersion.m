function Y = channel_add_chromatic_dispersion(X, L, SpS, Rs, D, CWavelength)
%CHANNEL_ADD_CHROMATIC_DISPERSION  Apply chromatic dispersion.
%
%   Y = channel_add_chromatic_dispersion(X, L, SpS, Rs, D, CWavelength)
%
%   Inputs
