function Out = recovery_fxp(In, PSType, NSymb, ki, kp, T) %#codegen
%recovery_FXP  Fixed-point clock recovery (DPLL: interpolator + TED + loop filter + NCO).
%
%   Out = recovery_fxp(In, PSType, NSymb, ki, kp, T)
%
%   Inputs
...
%     T      - fixed-point types table from recovery_fxp_types
%
%   Output
