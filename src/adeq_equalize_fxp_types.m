function T = adeq_equalize_fxp_types(dt) %#codegen
%ADEQ_EQUALIZE_FXP_TYPES  Data-type table for adeq_equalize_fxp.
%
%   T = adeq_equalize_fxp_types(dt)
%
%   Returns a struct of fi prototype objects (empty values) that define
%   every fixed-point type used inside adeq_equalize_fxp.
%
...
%     T.R_RDE  - RDE target radii
    ...
    switch dt
        ...
        otherwise
            error('adeq_equalize_fxp_types:BadType', ...
