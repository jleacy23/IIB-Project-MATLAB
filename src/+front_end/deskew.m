...
% filter of length 'N+1'. The temporal misalignment is compensated       %
% taking into account the lowest temporal delay. The temporal delays of  %
% each of the input signal (in-phase and quadrature components) are       %
% specified in 'ParamSkew'.                                              %
%                                                                        %
% Input:                                                                 %
%   rIn       = Input signal in which deskew will be performed. For       %
%               transmission in single pol. orientation, 'rIn' must be a  %
%               matrix with two columns. The 1st and 2nd columns must     %
%               have the in-phase and quadrature components of the        %
%               signal, respectively. For transmission with pol.          %
%               multiplexing, 'rIn' must be a matrix with four columns.   %
%               The 1st and the 2nd columns must have the in-phase and    %
%               quadrature components of the signal in V pol.             %
%               orientation, while the 3rd and 4th columns, the in-phase  %
%               and quadrature components of the signal in H pol.         %
...
%                                                                        %
% Output:                                                                %
%   rOut      = Signal after deskew. 'rOut' is arranged in columns in the %
%               same way as 'rIn';                                       %
%                                                                        %
