function T = viterbiViterbi_fxp_types(dt) %#codegen
%vitERBIVITERBI_FXP_TYPES  Data-type table for viterbiViterbi_fxp.
%
%   T = viterbiViterbi_fxp_types(dt)
%
%   Returns a struct of fi prototype objects (empty values) that define
%   every fixed-point type used inside viterbiViterbi_fxp.
%
...
%     T.acc    - accumulator for inner products / sums
    ...
    switch dt
        ...
        otherwise
            error('viterbiViterbi_fxp_types:BadType', ...
