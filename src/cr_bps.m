function [v, ThetaPU] = cr_bps(z, N, NPol, M, B, BlockLen, StepSize, ...
                                Pilots, UsePilots, PilotThreshold)
%CR_BPS  Blind Phase Search (BPS) carrier phase recovery.
%
%   [v, ThetaPU] = cr_bps(z, N, NPol, M, B, BlockLen, StepSize,
%                           Pilots, UsePilots)
%
%   Inputs
...
%               Between steps: held from the most recent step.
    ...
    %
    %  Same structure as cr_viterbiViterbi: sequential loop for the
