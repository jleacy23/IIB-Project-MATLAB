function Out = cdeq_equalize(In, D, L, CLambda, Rs, NPol, SpSIn, NFFT)
%CDEQ_EQUALIZE  Overlap-save frequency-domain CD compensation.
%
%   Out = cdeq_equalize(In, D, L, CLambda, Rs, NPol, SpSIn, NFFT)
%
