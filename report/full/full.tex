...
\subsection{Coarse CFO correction}
Explain how 
...
The equaliser must be at least 22 samples long to compensate chromatic dispersion and may need to be longer to also act as a matched filter. At this length a frequency domain filter will offer reduced complexity, and given that PMD is negligible, converting the adaptive equaliser to the frequency domain is unecessary. The most efficient approach will then employ a static frequency domain equaliser and a single tap time-domain adaptive equaliser. Both Gardner and Godard clock recovery are viable with this approach, and can be placed between the static and adaptive equalisers. 

\section{Results \& Discussion}
\subsection{}
% --- FEC SNR per configuration (FEC BER = 2e-02) ---
% block              NCD   NTaps   po2   ki        kp        FEC SNR    std       
% cd_gardner_cma     22    1       0     1.0e-07   1.0e-06      3.98       0.24   
% cd_gardner_cma     22    1       1     1.0e-06   1.0e-06      8.47       0.30   
% cd_gardner_cma     41    1       0     1.0e-07   1.0e-06      3.93       0.23   
% cd_gardner_cma     41    1       1     1.0e-06   1.0e-05      8.41       0.34   
% cd_godard_cma      22    1       0     1.0e-06   1.0e-05      4.41       0.30   
% cd_godard_cma      22    1       1     1.0e-05   1.0e-05      7.04       0.15   
% cd_godard_cma      41    1       0     1.0e-06   1.0e-05      4.32       0.30   
% cd_godard_cma      41    1       1     1.0e-04   1.0e-04      6.40       0.12 
