function [v, ThetaPU] = cr_bps_fxp(z, N, NPol, M, B, BlockLen, StepSize, ...
...
%
%   [v, ThetaPU] = cr_bps_fxp(z, N, NPol, M, B, BlockLen, StepSize,
...
%       Decisions (qam_slicer) are inherently double; keeping the metric in
